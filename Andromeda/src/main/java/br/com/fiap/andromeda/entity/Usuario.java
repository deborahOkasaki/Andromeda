...
public class Usuario {
	...
	public Usuario(int cdUsuario, String nmUsuario, String nrCpf, String dsEmail, String dsSenha) {
		super();
	...
	public void setAll(int cdUsuario, String nmUsuario, String nrCpf, String dsEmail, String dsSenha) {
		this.setCdUsuario(cdUsuario);
		this.setNmUsuario(nmUsuario);
		this.setNrCpf(nrCpf);
		this.setDsEmail(dsEmail);
