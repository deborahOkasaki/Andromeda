    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <c:forEach items="${listRes}" var="res" varStatus="loop">
                    ...
                    <div class="res-card">
                        <div class="res-header" id="reshead${loop.index}">
                            ...
                            <div class="options">
	                            ...
	                            <a class="add" data-toggle="modal" data-target="#addCom" onClick="toCreateCom(${res.cdResidencia})"><img src="/assets/add.svg"/ alt="adicionar cÙmodo"></a>
                            </div>
                                       ...
                                       <div class="com-header" id="res${loop.index}-comheader${cLoop.index}">
                                           <a class="com-toggle" data-toggle="collapse"
                                               ...
                                               <div class="com-info">
                                                   ...
                                                   <br />
                                                   <span class="com-desc">Gasto mÈdio R$80/mÍs</span>
                                               </div>
                                           </a>
                                           
                                           <!-- Botao para edicao de comodo -->
                                           <a class="editComodo" data-toggle="modal" data-target="#editCom" onClick="toEditCom(${com.cdComodo}, '${com.nmComodo}')"><img src="/assets/g_edit.svg"/></a>
                                                       		...
                                                       		<c:choose>
                                                       			<c:when test="${listAp.size() > 0}">
		                                                               ...
		                                                               <div class="ap-display">
		                                                                   ...
		                                                                   <div class="ap-desc">
		                                                                       <!-- <span class="ap-name">MonitorÄù</span>
		                                                                       <br/>
		                                                                       <span class="ap-desc">Consumo R$0.70/hora. Gasto estimado: R$15,00/m√™s</span> -->
                ...
                <%@include file="../commons/homeModal/modalEditCom.jspf"%>                
            </div>
        </div>
        </div>
        </div>
